...
# Initialize an empty list to store Acceleration intensity values
intensity_values = []

# Read data from the text file
with open('../datas/acceleration_data.txt', 'r') as file:
    for line in file:
...
# Customize the graph
plt.title('Acceleration Intensity Over Time')
plt.xlabel('Time (seconds)')
plt.ylabel('Acceleration Intensity')
